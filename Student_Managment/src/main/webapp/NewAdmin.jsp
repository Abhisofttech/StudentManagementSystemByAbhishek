...
<h3>Create New Admin</h3>
	<form name="form1" method="post" action="NewAdminData.jsp">
		
		<div class="tbl">
		<p>Enter the Admin details  </p>
		<table>
			<tr>
				<td class="text">Admin's Name:</td>
				<td><input type="text" name="name" value="" size=15 required></td>
			</tr>
			<tr>
				<td class="text">Admin's Username:</td>
				<td><input type="text" name="username" value="" size=15 required></td>
			</tr>
			<tr>
				<td class="text">Admin's Email:</td>
